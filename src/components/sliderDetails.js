...
export default function SliderDetails(props) {
    ...
    return (
        <div className="absolute inset-0 md:top-[25%] md:pt-0 pt-[30px]  rounded-[5px] top-[0%] items-center justify-center   md:h-[600px] h-full  w-full md:flex hidden   z-10">
            <div className=" w-3/4 flex items-center justify-center  p-20  ">
