        ...
        <div className='flex w-full md:h-1/2 h-full bg-black flex-col ' >
            <div className="bg-black w-full h-full flex gap-x-1 md:flex-row flex-col  md:px-[100px]">
                <div className="md:w-1/4 w-full  h-full  md:p-10  p-2 flex-col gap-y-[10px]">
                    ...
                    />
                    <ContactItem title="Working Hours:Mon-Fri (9 am - 6 pm EAT)"
                        icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"
                            className="w-8 h-8 text-gold">
                ...
                <div className="md:w-1/4 w-full h-full md:p-10  p-2 flex flex-col ">
                    <TitleOver title="Services" fontSize="20px" color="white" />
                    <ArrowListItem pb='20px' title="Mining" />
                    <ArrowListItem pb='20px' title="Refining" />
                    <ArrowListItem pb='20px' title="Transportation" />
                    <ArrowListItem pb='20px' title="Scaling" />
                </div>
